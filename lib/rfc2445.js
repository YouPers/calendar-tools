      ...
      switch (ev.frequency) {
        ...
        case 'month':
          rrule += st == 0
                    ? 'RRULE:FREQ=MONTHLY'
                    : (st == 2
                        ? (ev.recurrence['repeaton'].mode == 'day-of-month'
        ...
        case 'week':
          var days = '';
          for (var l in ev.recurrence['repeaton'])
    ...
    // - monthly mode - day on week
      ...
      if (_freq == 'WEEKLY') {
        ...
        for (var l = 0; l < days.length; l++) {
          ...
          recObj['repeaton'][key] = 'on';
        };
      }
      else if (_freq == 'MONTHLY') {
        // for monthly trecurrence type simply defines mode
        recObj['repeaton'].mode = 'day-of-week';
        
      }
    }

    // BYMONTHDAY/repeaton. Used for:
    // - monthly mode
    else if (prp[0] == 'BYMONTHDAY')
      recObj['repeaton'].mode = 'day-of-month';
